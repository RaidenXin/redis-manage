 ...
 * C</a>
 */
public final class RedisClusterSlotUtil {
    ...
    private RedisClusterSlotUtil() {
        throw new InstantiationError("Must not instantiate this class");
    }

    public static int getSlot(String key) {
        if (key == null) {
            throw new IllegalArgumentException("Slot calculation of null is impossible");
        }
    ...
    private static int getCRC16(String key) {
        ...
        byte[] bytesKey = key.getBytes(Charset.forName("UTF-8"));
